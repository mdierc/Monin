...
FROM     sys.server_role_members srm
         JOIN sys.server_principals sp1 ON sp1.principal_id = srm.member_principal_id
         JOIN sys.server_principals sp2 ON sp2.principal_id = srm.role_principal_id
WHERE    sp1.name NOT IN ( 'sa', 'NT SERVICE\SQLWriter', 'NT SERVICE\Winmgmt',
